...
#define __BYTES_TO_UINT64(a, b, c, d, e, f, g, h)                      \
    (((uint64_t)((a) & 0xff) << 56) | ((uint64_t)((b) & 0xff) << 48) | \
     ((uint64_t)((c) & 0xff) << 40) | ((uint64_t)((d) & 0xff) << 32) | \
     ((uint64_t)((e) & 0xff) << 24) | ((uint64_t)((f) & 0xff) << 16) | \
     ((uint64_t)((g) & 0xff) << 8) | ((uint64_t)(h) & 0xff))
#else
#define __BYTES_TO_UINT64(a, b, c, d, e, f, g, h)                      \
    (((uint64_t)((h) & 0xff) << 56) | ((uint64_t)((g) & 0xff) << 48) | \
     ((uint64_t)((f) & 0xff) << 40) | ((uint64_t)((e) & 0xff) << 32) | \
     ((uint64_t)((d) & 0xff) << 24) | ((uint64_t)((c) & 0xff) << 16) | \
...
static inline uint8_t is_unprotected_port(uint16_t port_id)
{
...
static inline void free_pkts(struct rte_mbuf *mb[], uint32_t n)
{
    uint32_t i;
